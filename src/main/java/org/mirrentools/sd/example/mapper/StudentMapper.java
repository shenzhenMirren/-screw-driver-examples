...
public interface StudentMapper {
	 ...
	 * @return
	 */
	List<Student> selectAll(SqlAssist assist);
	 ...
	 * @return
	 */
	default LimitResult<Student> limitAll(SqlAssist assist) {
		if (assist == null) {
		...
		LimitResult<Student> result = new SqlAssist().new LimitResult<Student>(count, assist.getPage(), assist.getRowSize());
		if (count == 0) {
			return result;
		}
		List<Student> data = selectAll(assist);
		result.setData(data);
		return result;
	}
	 ...
	 * @return
	 */
	Student selectSingleByObj(Student data);
	 ...
	 * @return
	 */
	List<Student> selectByObj(Student data);
	 ...
	 * @return
	 */
	int insertNotNull(Student data);
	 ...
	 * @return
	 */
	int insertBatch(List<Student> data);
	 ...
	 * @return
	 */
	int updateAllByAssist(@Param("data") Student data, @Param("assist") SqlAssist assist);
	 ...
	 * @return
	 */
	int updateNotNullByAssist(@Param("data") Student data, @Param("assist") SqlAssist assist);
	/**
	 * 通过id获取数据
	 * 
	 * @param id
	 ...
	 * @return
	 */
	int updateAllById(Student data);
	 ...
	 * @return
	 */
	int updateNotNullById(Student data);
}
